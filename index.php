...
<section id="posts">
 <nav id="menu">
  <ul>
   <li><a href="index.php" title="Home page">Home 2</a></li>
   <li><a href="index.php?pg=about_me" title="About Me">About Me 2</a></li>
   <li><a href="index.php?pg=images" title="Images">Images 2</a></li>
  </ul>
 </nav>
